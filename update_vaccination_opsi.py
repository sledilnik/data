...
def import_opsi_vaccination_effects():
    ...
    saveurl("https://podatki.gov.si/dataset/47edd697-a06b-44a6-86b7-0092ea34274a/resource/27e2b3d2-52b4-4899-be5c-9ee28a91bed5/download/pc14dnipozpublic.csv", "csv/vaccination-confirmed-cases-opsi.csv", "text/csv")
